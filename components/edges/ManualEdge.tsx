  ...
  return (
    <>
      <BaseEdge
        ...
        style={{
          ...style,
          // "İp" gibi görünür ama yol gibi kalın değil
          stroke: selected ? '#1d4ed8' : (style as any)?.stroke || '#2563eb',
          strokeWidth: Math.max(((style as any)?.strokeWidth as number) || 0, selected ? 4 : 3),
          opacity: 0.9,
          strokeLinecap: 'round',
          strokeLinejoin: 'round',
          // Çok hafif gölge (yol efekti yapmasın)
