    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <Calendar className="w-4 h-4 inline mr-1" /> İşe Giriş Tarihi
            </label>
            <input
              type="text"
              value={startDate}
              ...
              disabled={readOnly}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-100"
              placeholder="Örn: Ocak 2023, 15.01.2023"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              <Link className="w-4 h-4 inline mr-1" /> Görev Tanımı Linkleri
            </label>
            <textarea
              value={jobDescriptionLinks}
              onChange={(e) => setJobDescriptionLinks(e.target.value)}
              disabled={readOnly}
              rows={3}
              ...
              placeholder="Linkleri virgülle ayırarak girin: https://link1.com, https://link2.com"
            />
            <p className="text-xs text-gray-500 mt-1">Birden fazla link için virgülle ayırın</p>
          </div>
